...
RUN pip uninstall -y xgboost && DS_BUILD_UTILS=1 DS_BUILD_FUSED_LAMB=1 pip install deepspeed==0.7.3
...
# Core packages
RUN pip install transformers==4.22.2 datasets==2.5.1 pytorch-lightning==1.7.7 triton==2.0.0.dev20221003 wandb==0.13.3 timm==0.6.11 torchmetrics==0.9.3

# For MLPerf
RUN pip install git+https://github.com/mlcommons/logging.git@2.1.0-rc1
